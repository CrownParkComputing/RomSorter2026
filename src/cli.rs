...
pub fn build_merge_filename(input_paths: &[&str], output_type: &str) -> String {
...
pub struct RenameOptions {
    ...
    pub no_version: NoVersionMode,
    pub dlc_mode: DlcRenameMode,
}
...
pub fn build_merge_filename_metadata(
    input_paths: &[&str],
    output_type: &str,
    ks: &KeyStore,
    nutdb: &NutdbStore,
...
pub fn collect_title_records(
    ...
    if by_title.is_empty() && !input_paths.is_empty() {
